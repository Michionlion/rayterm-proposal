...
Using Unicode block characters to simulate pixels and a raytracer written in C++, a fully three dimensional scene can be rendered, complete with lighting, shadows, and physically-based materials.
